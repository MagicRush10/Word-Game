...
const CONFIG = {
  ...
  themes: {
    ...
    mezzi: ["BUS", "AUTOMOBILE", "MOTOCICLETTA", "AEREO", "BARCA", "TRAGHETTO", "BICICLETTA", "MONOPATTINO", "CAMION", "TRENO", "METROPOLITANA", "FILOBUS", "TAXI", "TRAM", "NAVE"],
    verdura: ["CAROTA", "PATATA", "RAPA", "BROCCOLO", "SPINACI", "BIETOLE", "LATTUGA", "CICORIA", "CARCIOFO", "ZUCCA", "FAGIOLI", "CAVOLFIORE", "LENTICCHIA", "PISELLI", "PORRO"],
    colori: ["ROSSO", "BIANCO", "AZZURRO", "VERDE", "GIALLO", "ARANCIONE", "PORPORA", "VIOLA", "BLU", "TAN", "CIANO", "TURCHESE", "MAGENTA", "NERO", "FUCSIA"],
  },
