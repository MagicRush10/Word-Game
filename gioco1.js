...
const dizionario = [
  "ZUCCA", "PANNO", "LENTO", "CREDO", "TATTO", "TIGRE", "VETRO", "DONNA", "LIBRO", "PENNA",
  "SALTO", "CREMA", "MATTO", "ZAINO", "AMORE", "CIELO", "FELPA", "SOGNO", "CARTA", "CAMPO",
  "TENDA", "FORNO", "LINEA", "PASTA", "BANCA", "VALLE", "RADIO", "MIELE", "CANTO", "METRO",
  "PELLE", "NERVO", "TORRE", "VENTO", "FUOCO", "PORTO", "BIRRA", "MOLTO", "OMBRA", "VERBO",
  "TONNO", "COSTA", "TRENO", "SEDIA", "GATTO", "CUORE", "MONDO", "PIANO", "GONNA", "VERDE",
  "ROSSO", "COLLE", "ABETE", "ACERO", "AGIRE", "ALBUM", "AMIDO", "ANICE", "AROMA", "AUDIO",
  "TEMPO", "AVENA", "BALZA", "BARBA", "BENNA", "BEOTA", "BOTTE", "BRUCO", "COLLO", "CASCO",
  ...
  "FILMO", "FIONA", "FOGNA", "FOLTO", "FONDO", "FORZA", "FRANA", "FRATE", "FRIGO", "FOLLA",
  "VIDEO", "VIOLA", "VISTA", "VISTO", "BELLA", "BELLO", "KOALA", "PROVA", "PROVO", "PROVE",
  "GIOCO", "GESSO", "GRIDO", "GRIDA", "FETTA", "ALTRO", "ALTRA", "KAPPA", "POLPO", "POLPA",
