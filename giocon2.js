document.addEventListener('DOMContentLoaded', () => {
    ...
    const backToMenuStartBtn = document.getElementById('back-to-menu-start-btn'); // Nuovo pulsante
    ...
    const backToMenuModalBtn = document.getElementById('back-to-menu-modal-btn'); // Nuovo pulsante
    ...
    const texts = [
        ...
        'Sviluppare giochi per il browser è un\'esperienza entusiasmante. Con HTML, CSS e JavaScript si possono creare mondi interattivi e divertenti senza la necessità di complessi setup.',
    ...
    // --- Aggiornamenti dell'UI e Calcoli ---
    ...
    // Funzione di reset della classifica (solo per sviluppatori tramite URL)
    ...
    // Event listener per il pulsante "Torna al menu" nella schermata iniziale
    backToMenuStartBtn.addEventListener('click', () => {
        window.location.href = 'https://thewordgames.netlify.app/altrigiochi.html';
    });

    // Event listener per il pulsante "Torna al menu" nel modal dei risultati
    backToMenuModalBtn.addEventListener('click', () => {
        window.location.href = 'https://thewordgames.netlify.app/altrigiochi.html';
    });

    // Logica per il reset della classifica tramite URL (per sviluppatori)
